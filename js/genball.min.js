...
genball.generators.game = function(data, kickdata, home, away, gameId, startTime, gameSeed, debug) {
    ...
    var punt = function(driveState, play) {
        ...
        var receivingTeam = teams[otherTeam(puntingTeam)];
    ...
    var playUntil = function(currentTime) {
        ...
        if (driveState.clock === 0 && driveState.quarter === 2) {
            ...
            driveState.driveNumber++;
            driveState.possession = otherTeam(firstToKick);
            driveState = kickoffSetup(driveState);
...
genball.models.team = function(info, coach, OC, DC, tempo, players, institution, stadium, id, logo) {
    ...
    var returners = _.chain(players).select(function(player) {
        return _.contains([ "WR1", "WR2", "WR3", "WR4", "CB", "S" ], player.position);
    }).sample(2).value();
