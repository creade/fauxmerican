...
genball.generators.bowlGame = function(data, kickdata, opponent, gameId, startTime, gameSeed, debug) {
    return {
        setGame: function(fauxTeam, oppRanking) {
            ...
            var bowlGame = genball.generators.game(data, kickdata, bowlTeams[0], bowlTeams[1], gameId, startTime, gameSeed, 9, debug);
...
genball.generators.teams = function(data, firstNames, lastNames, logos) {
    var generators = {
