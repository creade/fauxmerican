...
genball.generators.game = function(data, kickdata, home, away, gameId, startTime, gameSeed, week, debug) {
    ...
    var play = function() {
        ...
        if (driveState.kickoff) {
            ...
            play = playGenerator.nextPlay(driveState.quarter, driveState.down, driveState.distance, driveState.at, teams[driveState.possession]);
        }
...
genball.generators.play = function(data) {
    var nextPlay = function(quarter, down, distance, at, possession) {
...
genball.models.scoreboard = function(home, away) {
    ...
    var score = function(team, driveState, play, points, quarter) {
        ...
        var quarterName = quarters[quarter];
        line[quarterName](line[quarterName]() + points);
    };
    return {
        score: score,
