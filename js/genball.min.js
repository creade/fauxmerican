...
genball.generators.gameName = function(firstNameGenerator, lastNameGenerator) {
    var sponsors = [ "Oceanic Airlines", "Alchemax", "AmerTek", "Carver Media", "Contoso", "Octan", "National Motors", "Kord", "HaspelCorp" ];
...
genball.models.team = function(info, coach, OC, DC, tempo, players, institution, stadium, id, logo, skill, outOfConference) {
    ...
    var generators = {
        ...
        teamGenerator: function(teamInfoGenerator, fullNameGenerator, institutionGenerator, playerGenerator, stadiumGenerator, uniformGeneratorGenerator, logoGenerator) {
            ...
            var next = function(outOfConference) {
                ...
                var id = teamId;
                teamId++;
                return genball.models.team(info, coach, OC, DC, tempo, players, institution, stadium, id, logo, skill, outOfConference);
            };
            return {
                next: next
            };
