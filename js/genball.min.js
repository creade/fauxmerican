...
genball.generators.game = function(data, kickdata, home, away, gameId, startTime, gameSeed, week, debug) {
    ...
    var extraPoint = function(driveState) {
        if (driveState.quarter === 4 && _.contains([ -30, -29, -27, -26, -24, -22, -19, -18, -16, -15, -13, -12, -8, -5, -2, 1, 2, 5, 12, 19, 26 ], scoreboard.getDifferenital(driveState.possession) + 6) || driveState.quarter > 6) {
