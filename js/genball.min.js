...
genball.generators.game = function(data, kickdata, home, away, gameId, startTime, gameSeed, week, debug) {
    ...
    var goForTwo = function(driveState, scoreboard) {
        return driveState.quarter === 4 && _.contains([ -30, -29, -27, -26, -24, -22, -19, -18, -16, -15, -13, -12, -8, -5, -2, 1, 2, 5, 12, 19, 26 ], scoreboard.getDifferenital(driveState.possession) + 6) || driveState.quarter > 6;
    };
    ...
    var fumble = function(driveState, play) {
        ...
        if (driveState.at === 0) {
            ...
            driveState.commentary += "Recovered by " + recoverer.fullName + " at the " + driveState.at;
        }
        return driveState;
    };
...
genball.generators.schedule = function() {
    ...
    var scheduleEvents = function(startWeek) {
        ...
        events.push({
            startTime: moment.tz("America/Detroit").week(startWeek + 10).day(1).hour(0).minute(0).second(0),
